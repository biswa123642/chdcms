...
const uploadFontsTasks = getTask('uploadFonts');
const uploadGulpConfigTasks = getTask('uploadGulpConfig');
const watchMapJsTasks = getTask('watchMapJs');
const watchMapCssTasks = getTask('watchMapCss');
const uploadMapJsTasks = getTask('uploadMapJs');
const uploadMapCssTasks = getTask('uploadMapCss');
...
module.exports.watchMapJs = gulp.series(login, watchMapJsTasks);
module.exports.watchMapCss = gulp.series(login, watchMapCssTasks);
//Watch SASS
...
module.exports.uploadAll = gulp.series(
    login,
    uploadJsTasks,
    uploadCssTasks,
    uploadImgTasks,
...
module.exports.uploadMapJs = gulp.series(login, uploadMapJsTasks);
module.exports.uploadMapCss = gulp.series(login, uploadMapCssTasks);
module.exports.uploadCss = gulp.series(login, uploadCssTasks);
module.exports.uploadImg = gulp.series(login, uploadImgTasks);
module.exports.uploadFonts = gulp.series(login, uploadFontsTasks);
